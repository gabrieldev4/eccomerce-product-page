...
export function DropDown(){
    ...
    console.log(item)
    return (
        <div className="py-4 min-h-52 min-w-80 sm:w-96 sm:right-20 mx-2 absolute shadow-xl shadow-dark-grayish-blue top-20 bg-white rounded-lg z-40">
                ...
                <div className="px-6">
                    <div className="flex items-center gap-6 justify-center my-6">
                        ...
                        <div>
                            ...
                            <p className="block text-dark-grayish-blue">$125.00 x{item} <span className=" text-very-dark-blue font-semibold">{valueTotal}</span></p>
                        </div>
            ...
            :(
                <div className="flex items-center min-h-36 mb-6 justify-center ">
